...
const Cookies = () => {
  ...
  const sections = [
    ...
    { id: "tipos", title: "2. Tipos que usamos" },
    { id: "gestion", title: "3. Gestión del consentimiento" },
    { id: "navegador", title: "4. Cambiar cookies en el navegador" },
    { id: "tabla", title: "5. Cookies que puede instalar el sitio" },
    { id: "mas-info", title: "6. Más información" },
  ];
